...
namespace POS.Infrastructure.Persistences.Repositories
{
    public class CategoryRepository : GenericRepository<Category>, ICategoryRepository
    {
        ...
        public async Task<BaseEntityResponse<Category>> ListCategories(BaseFiltersRequest filters)
        {
            ...
            var categories = (from c in _context.Categories where c.AuditDeleteUser == null && c.AuditDeleteDate == null select c).AsNoTracking().AsQueryable();
        ...
        public async Task<bool> EditCategory(Category category)
        {
            ...
            _context.Entry(category).Property(x => x.AuditCreateUser).IsModified = false; //En caso de que este audit venga modificado, evitar su actualización en base de datos
